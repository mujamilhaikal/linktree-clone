document.addEventListener("DOMContentLoaded", function () {
  ...
  try {
    ...
    console.error("Lazy loading images failed:", error);
  }
  ...
  const adjustProfilePictureSize = () => {
    try {
      ...
      console.error("Adjusting profile picture size failed:", error);
    }
  };
  ...
  function getRandomQuote() {
    try {
      ...
      console.error("Getting random quote failed:", error);
      return "Error: Unable to retrieve a quote.";
    }
  }
  ...
  try {
    ...
    console.error("Inserting quote into container failed:", error);
  }
  ...
  try {
    ...
    console.error("Setting footer text failed:", error);
  }
});
